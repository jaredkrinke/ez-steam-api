...
const ez_steam_string = koffi.disposable(
    "ez_steam_string",
    "string",
    lib.func("int ez_steam_string_free(void*)"),
);
...
const steamRaw = {
    ...
    getAchievement: lib.func("int ez_steam_achievement_get(string achievement_id, _Out_ int* out_achieved)"),
    setAchievement: lib.func("int ez_steam_achievement_set(string achievement_id, _Out_ int* out_newly_achieved)"),
    storeAchievements: lib.func("int ez_steam_achivements_store()"),
};
